  ...
  return (
    ...
    >
      ...
      <mesh position={[0, 2, 0]} receiveShadow castShadow>
        ...
        <meshStandardMaterial ref={materialRef} color="#a3a3a3" roughness={1.0} emissiveIntensity={0.5} />
      </mesh>
